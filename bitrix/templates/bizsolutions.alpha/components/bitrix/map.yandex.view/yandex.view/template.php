...
$this->createFrame()->begin('Loading Map');

if ($arParams['BX_EDITOR_RENDER_MODE'] == 'Y'):
?>
<img src="<?= $templateFolder ?>/images/screenshot.png" border="0" />
<?
else:
...
<?
	$APPLICATION->IncludeComponent('bitrix:map.yandex.system', 'yandex.system', $arTransParams, false, array('HIDE_ICONS' => 'Y'));
?>
	</div>
</div>
<?
