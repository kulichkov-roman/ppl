...
foreach ($arResult['ITEMS'] as $key => $arItem) {
    ...
    if ($arItem['IPROPERTY_VALUES']['ELEMENT_PREVIEW_PICTURE_FILE_ALT'] && $arItem['PREVIEW_PICTURE']) {
        $arResult['ITEMS'][$key]['PREVIEW_PICTURE']['ALT'] = $arItem['IPROPERTY_VALUES']['ELEMENT_PREVIEW_PICTURE_FILE_ALT'];
    }
    if ($arItem['IPROPERTY_VALUES']['ELEMENT_PREVIEW_PICTURE_FILE_TITLE'] && $arItem['PREVIEW_PICTURE']) {
